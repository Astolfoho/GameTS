    ...
    (function (Controllers) {
        var KeyBoard = (function () {
            function KeyBoard(canvas) {
                var _this = this;
                this.canvas = canvas;
                canvas.addEventListener("keydown", function (ev) { return _this.canvas_KeyDown(ev); });
                canvas.addEventListener("keyup", function (ev) { return _this.canvas_KeyUp(ev); });
            }
            KeyBoard.prototype.canvas_KeyDown = function (event) {
                this[KeyCodes[event.keyCode]] = true;
            };
            KeyBoard.prototype.canvas_KeyUp = function (event) {
