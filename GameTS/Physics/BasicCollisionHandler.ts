module GameTS.Physics {
    ...
    export class BasicCollisionHandler implements ICollisionHandler {
        ...
        private obj: Objects.BaseObject;
        private _objsToCollide: Array<Objects.BaseObject>;
        ...
        constructor(obj: Objects.BaseObject) {
            this.obj = obj;
            this._cells = [];
            this._objsToCollide = [];
            this.current = 0;
        ...
        public add(otherObj: Objects.BaseObject): void {
            this._objsToCollide.push(otherObj);
        }



        public isColliding(otherObj: Objects.BaseObject): CollisionResult {
        ...
        private firstPhase(otherObj: Objects.BaseObject): CollisionResult {
        ...
        private secondPhase(otherObj: Objects.BaseObject): boolean {
    ...
    class CollisionCell implements ICollisionInfo {
        ...
        public w: number;
        public h: number;
        public parent: Objects.BaseObject | CollisionCell;
        public topCell: CollisionCell;

        constructor(x: number, y: number, w: number, h: number, parent: Objects.BaseObject | CollisionCell) {
            this._baseX = x * w;
            this._baseY = y * h;
            this.w = w;
            this.h = h
        ...
        public isColliding(otherObj: Objects.BaseObject | CollisionCell): CollisionCell {
